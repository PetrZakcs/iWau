        ...
        <div className="section-container py-12 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-4">
          ...
          <div className="flex flex-col items-center md:items-end gap-3">
            ...
            <div className="flex gap-4">
              <Link to="/obchodni-podminky" className="text-[10px] text-muted-foreground/60 hover:text-muted-foreground transition-colors">Obchodní podmínky</Link>
              <Link to="/gdpr" className="text-[10px] text-muted-foreground/60 hover:text-muted-foreground transition-colors">Ochrana soukromí (GDPR)</Link>
            </div>
          </div>
        </div>
      </footer>
